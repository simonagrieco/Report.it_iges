...
class _InoltroPrenotazione extends State<InoltroPrenotazione> {
                ...
                children: [
                  ElevatedButton(
                    ...
                    onPressed: (() async {
                      ...
                      impegnativa = true;
                      await uploadImpegnativa();
                      print("Result: $result");
                      print("IMPEGNATIVA CONTROLLLER: $impegnativaController");
                    }),
  ...
  Future<void> uploadImpegnativa() async {
    ...
    if (fileResult != null) {
      if (fileResult.files.first.size <= 0 ||
          fileResult.files.first.size > 20971520) {
        result = "file-size-not-valid";
      } else {
